          ...
          <el-form-item class="input" label="单价" prop="danjia">
              <el-input v-model="ruleForm.danjia" 
                placeholder="单价" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="回收重量" prop="huishouzhongliang">
          <el-input v-model="ruleForm.huishouzhongliang" 
              placeholder="回收重量" clearable  :readonly="ro.huishouzhongliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="回收重量" prop="huishouzhongliang">
              <el-input v-model="ruleForm.huishouzhongliang" 
                placeholder="回收重量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" v-if="ruleForm.yuyueriqi" label="预约日期" prop="yuyueriqi">
              <el-input v-model="ruleForm.yuyueriqi" 
                placeholder="预约日期" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="上门时间" prop="shangmenshijian">
          <el-input v-model="ruleForm.shangmenshijian" 
              placeholder="上门时间" clearable  :readonly="ro.shangmenshijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="上门时间" prop="shangmenshijian">
              <el-input v-model="ruleForm.shangmenshijian" 
          ...
          <el-form-item class="input" label="账号" prop="zhanghao">
              <el-input v-model="ruleForm.zhanghao" 
                placeholder="账号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="回收员姓名" prop="huishouyuanxingming">
          <el-input v-model="ruleForm.huishouyuanxingming" 
              placeholder="回收员姓名" clearable  :readonly="ro.huishouyuanxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="回收员姓名" prop="huishouyuanxingming">
              <el-input v-model="ruleForm.huishouyuanxingming" 
                placeholder="回收员姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                                                                        </el-row>
...
export default {
  data() {
	...
	ispay : false,
            ...
            ruleForm: {
                  ...
                  huishouzhongliang: [
                            { required: true, message: '回收重量不能为空', trigger: 'blur' },
  ...
  computed: {
                                                                                    zongjiage:{
                                                                                                                                                                                                                                                                                                      get: function () {
        return 1*this.ruleForm.danjia*this.ruleForm.huishouzhongliang
      }
    },
                                                                                                                                                              },
  created() {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.danjia = true;
            continue;
	            	            ...
	            	            if(o=='huishouzhongliang'){
            this.ruleForm.huishouzhongliang = obj[o];
	    this.ro.huishouzhongliang = true;
            continue;
          }
	            	            if(o=='zongjiage'){
	    ...
	    this.ro.zhanghao = true;
            continue;
	            	            ...
	            	            if(o=='huishouyuanxingming'){
            this.ruleForm.huishouyuanxingming = obj[o];
	    this.ro.huishouyuanxingming = true;
            continue;
          }
	            	            	            	                    }
                                                                                                                                                                                                                                                                                                                              }
        ...
        if (data && data.code === 0) {
          var json = data.data;
              		...
              		this.ruleForm.zhanghao = json.zhanghao
                                  		...
                                  		if(json.huishouyuanxingming!=''&&json.huishouyuanxingming){
              		this.ruleForm.huishouyuanxingming = json.huishouyuanxingming
		}
                                                                                                } else {
