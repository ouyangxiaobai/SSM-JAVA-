          ...
          <el-form-item class="input" label="手机" prop="shouji">
              <el-input v-model="ruleForm.shouji" 
                placeholder="手机" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="负责地区" prop="fuzediqu">
          <el-input v-model="ruleForm.fuzediqu" 
              placeholder="负责地区" clearable  :readonly="ro.fuzediqu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="负责地区" prop="fuzediqu">
              <el-input v-model="ruleForm.fuzediqu" 
                placeholder="负责地区" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shouji = true;
            continue;
	            	            ...
	            	            if(o=='fuzediqu'){
            this.ruleForm.fuzediqu = obj[o];
	    this.ro.fuzediqu = true;
            continue;
          }
	                    }
                                                                                                                              }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `huishouyuan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.huishouyuanCrossAddOrUpdateFlag = false;
                  this.parent.search();
