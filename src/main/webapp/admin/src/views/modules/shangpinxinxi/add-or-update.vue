          ...
          <el-form-item class="input" v-if="ruleForm.faburiqi" label="发布日期" prop="faburiqi">
              <el-input v-model="ruleForm.faburiqi" 
                placeholder="发布日期" readonly></el-input>
                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                    <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="商品描述" prop="shangpinmiaoshu">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.shangpinmiaoshu" label="商品描述" prop="shangpinmiaoshu">
                    <span v-html="ruleForm.shangpinmiaoshu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.shangpinmiaoshu = this.ruleForm.shangpinmiaoshu.replace(reg,'../../../ssm3gwbm/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
