  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.22);borderRadius:10px">
        <h1 class="h1" style="color:rgba(104, 223, 240, 1);fontSize:28px;">废旧物品回收管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="手机" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.shouji" autocomplete="off" placeholder="手机" type="text" />
																								...
																								<!-- <div v-if="tableName=='huishouyuan'" class="input-group">
			   <div class="label">账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.zhanghao" class="input" type="text" placeholder="账号">
			   </div>
			 </div> -->
			<el-form-item label="账号" class="input" v-if="tableName=='huishouyuan'">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='huishouyuan'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='huishouyuan'" class="input-group">
			   <div class="label">回收员姓名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.huishouyuanxingming" class="input" type="text" placeholder="回收员姓名">
			   </div>
			 </div> -->
			<el-form-item label="回收员姓名" class="input" v-if="tableName=='huishouyuan'">
			  <el-input v-model="ruleForm.huishouyuanxingming" autocomplete="off" placeholder="回收员姓名" type="text" />
			</el-form-item>
																														<!-- <div v-if="tableName=='huishouyuan'" class="input-group">
			   <div class="label">手机</div>
			   <div class="input-container">
			...
			<el-form-item label="手机" class="input" v-if="tableName=='huishouyuan'">
			  <el-input v-model="ruleForm.shouji" autocomplete="off" placeholder="手机" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='huishouyuan'" class="input-group">
			   <div class="label">负责地区</div>
			   <div class="input-container">
			     <input v-model="ruleForm.fuzediqu" class="input" type="text" placeholder="负责地区">
			   </div>
			 </div> -->
			<el-form-item label="负责地区" class="input" v-if="tableName=='huishouyuan'">
			  <el-input v-model="ruleForm.fuzediqu" autocomplete="off" placeholder="负责地区" type="text" />
			</el-form-item>
  ...
  methods: {
    ...
    login() {
        ...
        return
                                                                  ...
                                                                  if((!this.ruleForm.zhanghao) && `huishouyuan` == this.tableName){
        this.$message.error(`账号不能为空`);
        return
      }
                                                                  if((!this.ruleForm.mima) && `huishouyuan` == this.tableName){
        this.$message.error(`密码不能为空`);
        return
      }
                                                                                                                                                                                                                                                            if(`huishouyuan` == this.tableName && this.ruleForm.shouji&&(!this.$validate.isMobile(this.ruleForm.shouji))){
        this.$message.error(`手机应输入手机格式`);
        return
      }
                                                                                                                                                                              this.$http({
