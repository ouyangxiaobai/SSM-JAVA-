          ...
          <el-form-item class="input" label="总价格" prop="zongjiage">
              <el-input v-model="ruleForm.zongjiage" 
                placeholder="总价格" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="佣金" prop="yongjin">
          <el-input v-model="ruleForm.yongjin" 
              placeholder="佣金" clearable  :readonly="ro.yongjin"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="佣金" prop="yongjin">
              <el-input v-model="ruleForm.yongjin" 
                placeholder="佣金" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `yongjinxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yongjinxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
